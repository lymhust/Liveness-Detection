function [cost,grad] = sparseAutoencoderCost_inandout(theta, visibleSize, hiddenSize, ...
                                             lambda, sparsityParam, beta, input, output)
...
delta3 = -(output - a3) .* sigmoidGrad(z3);
...
W1grad = (1. / m) * (delta2 * input') + lambda * W1;
...
cost = (1. / m) * sum((1. / 2) * sum((a3 - output).^2)) + ...
